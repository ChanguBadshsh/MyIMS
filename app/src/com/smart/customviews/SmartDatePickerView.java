...
public class SmartDatePickerView extends DatePickerDialog {
	...
	public SmartDatePickerView(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth, boolean isBirthDate) {
	...
	public SmartDatePickerView(Context context, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth, boolean isBirthDate) {
