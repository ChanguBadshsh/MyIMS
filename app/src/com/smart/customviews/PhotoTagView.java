...
public class PhotoTagView extends ImageView {
    ...
    private ArrayList<ContentValues> tagedUserList;
     ...
     */
    public ArrayList<ContentValues> getTagedUserList() {
     ...
     */
    public void setTagedUserList(ArrayList<ContentValues> tagedUserList) {
    ...
    private void drawCanvas(Canvas canvas) {
        try {
            if (getTagedUserList() != null) {
                int size = getTagedUserList().size();
                for (int i = 0; i < size; i++) {
                    tagedUserRect[i] = getDeviceRectFromData(getTagedUserList().get(i).getAsString("position"));

                    Rect textBound = new Rect();
                    textPaint.getTextBounds(getTagedUserList().get(i).getAsString("user_name"), 0,
                            getTagedUserList().get(i).getAsString("user_name").length(), textBound);
                    ...
                    canvas.drawText(getTagedUserList().get(i).getAsString("user_name"), tagedUserRect[i].left + convertSizeToDeviceDependent(3), tagedUserRect[i].bottom, textPaint);
                }
            }
