...
import com.smart.webservice.WebkitCookieManagerProxy;
...
public class SmartApplication extends Application {
    ...
    private void loadConfiguration() {
        ...
        Typeface typefaceNormal = Typeface.createFromAsset(getAssets(), SmartApplication.REF_SMART_APPLICATION.FONT_NAME);
        SmartApplication.REF_SMART_APPLICATION.FONT = typefaceNormal;

        Typeface typefaceBold = Typeface.createFromAsset(getAssets(), SmartApplication.REF_SMART_APPLICATION.BOLDFONT_NAME);
        SmartApplication.REF_SMART_APPLICATION.BOLDFONT = typefaceBold;
    }
